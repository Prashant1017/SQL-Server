...
alter trigger Playerstabledeletion
on Players
instead of delete
as
begin
	...
	print '***	You dont have permission to delete the players details	***'
	return
end
...
alter trigger CertainTimePeriod
on Players
instead of insert
as
begin
	...
	begin
		...
		rollback transaction
		print '--	Insert before 5PM or after 8PM	--'
		return
	end
end
...
insert into Players
values
(13, 'Alexander Isak', 'Newcastle United', 'Sweden', 'Forward')
